      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 h-14 grid grid-cols-2 sm:grid-cols-3 items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          <img
            ...
            className="h-6 w-6"
          />
          <span className="text-sm sm:text-base font-semibold tracking-tight">Entra RoleReaper</span>
        </div>
        ...
        <div className="flex items-center justify-end gap-2">
          ...
          <ThemeSwitcher />
          <UserMenu reviewerName={reviewerName} tenantDomain={tenantDomain} onLogout={onLogout} />
        </div>
      </div>
      {/* mobile nav */}
