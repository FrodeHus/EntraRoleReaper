...
namespace Data.Migrations
{
    ...
    [Migration("20250828173412_v0.44")]
    partial class v044
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntraRoleReaper.Api.Data.Models.TargetResource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("EntraRoleReaper.Api.Data.Models.TargetResourceProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("ActivityTargetResource", b =>
                {
                    ...
                    b.HasOne("EntraRoleReaper.Api.Data.Models.TargetResource", null)
                        .WithMany()
            ...
            modelBuilder.Entity("EntraRoleReaper.Api.Data.Models.TargetResourceProperty", b =>
                {
                    b.HasOne("EntraRoleReaper.Api.Data.Models.TargetResource", "TargetResource")
                        .WithMany("Properties")
                        .HasForeignKey("TargetResourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ResourceActionTargetResourceProperty", b =>
                {
                    ...
                    b.HasOne("EntraRoleReaper.Api.Data.Models.TargetResourceProperty", null)
                        .WithMany()
